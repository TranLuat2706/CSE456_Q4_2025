...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Student s1m1 = new Student("st1m1","Ngô Nhất",2000,85, LocalDateTime.now(),LocalDateTime.now());
        Student s2m1 = new Student("st2m1","Trương Nhị",2000,90, LocalDateTime.now(),LocalDateTime.now());
        Student s3m1 = new Student("st3m1","Phan Tam",2001,85, LocalDateTime.now(),LocalDateTime.now());
        Student s1m2 = new Student("st1m2","Lý Tứ",2002,95, LocalDateTime.now(),LocalDateTime.now());
        Student s2m2 = new Student("st2m2","Phạm Ngũ",2001,75, LocalDateTime.now(),LocalDateTime.now());
